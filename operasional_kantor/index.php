    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <!-- Notifications Menu -->
          <li ><a  style="padding-top: 0px;padding-bottom: 0px;margin-top:0px;margin-bottom:0px;display:block;" href="#"><p style="padding-top: 0px;padding-bottom: 0px;margin-top:0px;margin-bottom:0px;font-size:10px;">Sisa Cuti</p><p style="padding-top: 0px;padding-bottom: 0px;text-align: center;"><span class="label label-default"><?php echo $jumlah3?> hari</span></p></a></li>
		      <li ><a  style="padding-top: 0px;padding-bottom: 0px;margin-top:0px;margin-bottom:0px;display:block;" href="#"><p style="padding-top: 0px;padding-bottom: 0px;margin-top:0px;margin-bottom:0px;font-size:10px;">Uang Akomodasi</p><p style="padding-top: 0px;padding-bottom: 0px;"><span class="label label-default"><?php echo "Rp".number_format($jumlah2)?></span></p></a></li>
