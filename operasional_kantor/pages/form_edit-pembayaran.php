				...
				<div>
					...
					<section class="content-header" >
						<div class="container" style="width: 80%;"> 
							<form action="pages/proses_edit-pembayaran.php" method="POST" enctype="multipart/form-data">   
							    ...
							    <div class="form-group">
							      ...
							      <input class="form-control" type="number" id="nominal" name="nominal" value="<?php echo $row['nominal']?>">
							    </div>

							    <div class="form-group">
							      <label for="keterangan"> Keterangan </label>
							      <textarea class="form-control" rows="5" id="keterangan" name="keterangan" placeholder="Keterangan Pembayaran"> <?php echo $row['keterangan']; ?> </textarea>
							    </div>
							      ...
							      <div class="modal-dialog">  
							           <div class="modal-content">  
							                ...
							                <div class="modal-footer">  
							                     <a href="pages/proses_delete-bukti.php" class="btn btn-danger">HAPUS GAMBAR</a>    
					...
					<script>
					     $(document).ready(function(){  
					      $('.delete_data').click(function(){  
		         				var id = $(this).attr("id");
					              $.ajax({  
					                url:"pages/fetch_data_bukti-pembayaran.php",  
					                method:"post",  
					                data:{id:id},  
