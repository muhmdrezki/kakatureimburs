...
<div class="container bounceInLeft animated">
  ...
  <div class="form-group flipInX animated">
            <label> FILTER STATUS </label>
              <form method="POST" action="tampil/data-absensi"> 
                <div class="input-group"> 
        ...
        <?php
                if (isset($_POST["status_hadir"])) {
                  $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.status_id=1 AND d.id_anggota='$_SESSION[id_anggota]' ORDER BY d.tanggal DESC" ;
                } else if (isset($_POST["status_hadir_diluar"])) {
                  $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.status_id=2 AND d.id_anggota='$_SESSION[id_anggota]' ORDER BY d.tanggal DESC" ;
                } else if (isset($_POST["status_sakit"])) {
                  $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.status_id=3 AND d.id_anggota='$_SESSION[id_anggota]' ORDER BY d.tanggal DESC" ;
                } else if (isset($_POST["status_izin"])) {
                  $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.status_id=4 AND d.id_anggota='$_SESSION[id_anggota]' ORDER BY d.tanggal DESC" ;
                } else if (isset($_POST["status_cuti"])) {
                  $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.status_id=5 AND d.id_anggota='$_SESSION[id_anggota]' ORDER BY d.tanggal DESC" ;
                }  else if (isset($_POST["status_alpha"])) {
                  $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.status_id=6 AND d.id_anggota='$_SESSION[id_anggota]' ORDER BY d.tanggal DESC" ;
                } else if(isset($_POST["submit_tanggal"])){
					          //echo "<script>alert('asup')</script>";
                    $startdate = $_POST["start_date"];
					          //echo "<script>alert('$startdate')</script>";
                    $enddate = $_POST["end_date"];
                    $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.id_anggota='$_SESSION[id_anggota]' AND DATE(d.tanggal) BETWEEN STR_TO_DATE('$startdate', '%m/%d/%Y') AND STR_TO_DATE('$enddate', '%m/%d/%Y') ORDER BY d.tanggal DESC" ;
                } else {
                  $query = "SELECT d.id, d.id_anggota, a.nama, d.tanggal, d.jam_masuk, b.status, d.keterangan FROM tb_detail_absen d JOIN tb_absen b ON d.status_id=b.status_id JOIN tb_anggota a ON d.id_anggota = a.id_anggota WHERE d.id_anggota='$_SESSION[id_anggota]' ORDER BY d.tanggal DESC" ;
                }
            
           $result = mysqli_query($koneksi, $query);  
        ?>  
            <div class="table-responsive">  
               <table class="table table-bordered table-hover" id="data_absen">
               <thead>
                  <tr>  
                         <th> Waktu Submit </th>   
                         <th> Nama </th> 
